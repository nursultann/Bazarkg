        ...
        <div className="container-fluid">
          ...
          <header className="blog-header py-3">
            <div className="row flex-nowrap justify-content-between align-items-center">
              ...
              <div class="col-3 d-lg-flex justify-content-end align-items-center">
                {token == null ?
                  <>
                  <div className="d-none d-lg-block"> 
                    <Button  onClick={() => navigateTo('/register')} className="mr-2 rounded-pill" style={{backgroundColor:'#4dab04',color:"#fff"}}>Регистрация</Button>
                    <Button  onClick={() => navigateTo('/login')} className="mr-2 rounded-pill" style={{borderColor:'#4dab04',color:'#4dab04'}}>Войти</Button> 
                  </div>
